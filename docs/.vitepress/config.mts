...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "Lemoyne", collapsed: true, items:[
            ...
            {text: "🔸Braithwaite Manor", link:'/doc_mappings/lemoyne/spooni_bra_manor'},
            {text: "🔸Braithwaite Storage House", link:'/doc_mappings/lemoyne/spooni_bra_storage_house'},
            {text: "🔸Braithwaite Worker Houses", link:'/doc_mappings/lemoyne/spooni_bra_worker_houses'},
    ...
    footer: {
      ...
      copyright: '© 2022 - 2025 <a style="color: #f25c05;" href="https://discord.gg/spooni" target="_blank" rel="noopener noreferrer">SPOONI Development</a>',
    },   
  },
