...
declare const GOOGLE_TRANSLATE_SELECT_LANGUAGES_CODES: readonly ["en", "af", "sq", "ar", "hy", "az", "eu", "be", "bg", "ca", "zh-CN", "zh-TW", "hr", "cs", "da", "nl", "et", "tl", "fi", "fr", "de", "el", "hu", "id", "ga", "it", "ja", "ko", "lt", "ms", "no", "pl", "pt", "ro", "ru", "es", "sv", "th", "tr", "uk"];
